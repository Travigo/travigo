...
func ParseCifFile(reader io.Reader) (CommonInterfaceFormat, error) {
	cifFile := CommonInterfaceFormat{}
	...
	for scanner.Scan() {
		...
		case "AA":
			...
			cifFile.Associations = append(cifFile.Associations, association)
		case "BS":
			if holdingTrainDef {
				cifFile.TrainDefinitionSets = append(cifFile.TrainDefinitionSets, currentTrainDef)
			}
		...
		case "LI":
			intermediateLocation := IntermediateLocation{
				Location:               line[2:10],
				ScheduledDepartureTime: line[10:15],
				PublicDepartureTime:    line[15:20],
				ScheduledPass:          line[20:25],
				PublicArrival:          line[25:29],
				PublicDeparture:        line[29:33],
				Platform:               line[33:36],
				Line:                   line[36:39],
				Path:                   line[39:42],
				Activity:               line[42:54],
